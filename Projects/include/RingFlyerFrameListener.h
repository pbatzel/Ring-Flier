...
class RingFlyerFrameListener : public Ogre::FrameListener, public OIS::MouseListener, public OIS::KeyListener {
 private:
  ...
  public:
  RingFlyerFrameListener(RingFlyer* flyer, Ship* ship, SoundManager* soundMgr);
  ...
  {
        Ogre::Overlay* o = Ogre::OverlayManager::getSingleton().getByName("Core/TimeOverlay");
        if (!o)
  ...
  {
        Ogre::Overlay* o = Ogre::OverlayManager::getSingleton().getByName("Core/ScoreOverlay");
        if (!o)
            OGRE_EXCEPT( Ogre::Exception::ERR_ITEM_NOT_FOUND, "Could not find overlay Core/DebugOverlay", "showDebugOverlay" );
        if (show)
            o->show();
   ...
   void updateTime(float time)
   {
        ...
        Ogre::OverlayElement* timePanel = Ogre::OverlayManager::getSingleton().getOverlayElement("Core/Time");
